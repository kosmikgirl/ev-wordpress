    ...
    draw(groups) {
        ...
        if (Object.keys(this.options).length > 0) {
            Object.entries(this.options).forEach(([key, data]) => {
                ...
                wrap.className = 'wpcs-sd-option wpcs-sd-options-' + key;

                if (data.label) {
                    let label = document.createElement('div');
                    label.className = 'wpcs-sd-label';
                    label.innerText = data.label + ':';

                    if (data.tip) {
                        let tip = document.createElement('span');
                        tip.className = 'wpcs-sd-tooltip-toggle';
                ...
                switch (data.type) {
                    case 'slider':
                        ...
                        elem.className = 'ranger23-track wpcs-sd-slider';
                        ...
                        input.className = 'wpcs-sd-slider-input';
                    ...
                    case 'textinput':
                        ...
                        elem.className = 'wpcs-sd-text-input';
            ...
            Object.keys(groups).forEach((key) => {
                ...
                g.className = 'wpcs-sd-group';
                g.setAttribute('id', `wpcs-sd-section-${key}`);

                let header = document.createElement('header');
                header.innerText = groups[key].label;

                let curr_num = document.createElement('div');
                curr_num.innerText = '#' + wpcs_sd_current_edit_id;
                curr_num.className = 'wpcs-sd-section-header-num';
