...
class WPCS_SD_DD {
    constructor(demo_data, settings = {}) {
        this.container = document.getElementById('wpcs-sd-dd-options');
        this.menu = JSON.parse(document.getElementById('wpcs-sd-dd').getAttribute('data-menu'));
        this.create_nav();
        ...
        document.addEventListener('wpcs-sd-ctrl-z', (ev) => {
            if (ev.detail.wpcs_sd_dd === this) {
                //this.rollback();//TODO
            }
        });

        //need for correct visual in drop-down
        document.querySelector('.wpcs_sd_title_value').dispatchEvent(new Event('change'));
    ...
    init_options() {
        ...
        let options = {
            ...
            width_p100: {
                ...
                callback: (is, element) => {
                    ...
                    if (is) {
                        ...
                        document.querySelector('.wpcs-sd-options-width').style.display = 'none';
                    } else {
                        this.selector.setWidth(this.settings.width);
                        document.querySelector('.wpcs-sd-options-width').style.display = 'block';
            ...
            show_title: {
                ...
                callback: (is, element) => {
                    ...
                    hide_elements.forEach((val) => {
                        document.querySelector(`.wpcs-sd-options-${val}`).style.display = is ? 'block' : 'none';
                    });
            ...
            title_value: {
                label: wpcs_sd.lang.title_value,
                type: 'textinput',
                value: this.settings.title_value,
                group: groups.title,
                class: 'wpcs_sd_title_value',
                ...
                tip: wpcs_sd.lang.signs_using
            },
            title_font_size: {
                label: wpcs_sd.lang.title_font_size,
                type: 'slider',
                min: 8,
                max: 48,
            ...
            title_color: {
                label: wpcs_sd.lang.title_color,
                type: 'color',
            ...
            border_width: {
                label: wpcs_sd.lang.border_width,
                type: 'slider',
                min: 0,
                max: 10,
            ...
            border_radius: {
                label: wpcs_sd.lang.border_radius,
                type: 'slider',
                min: 0,
                max: 100,
            ...
            border_color: {
                label: wpcs_sd.lang.border_color,
                type: 'color',
            ...
            show_img: {
                ...
                callback: (is, element) => {
                    ...
                    if (is) {
                        document.querySelector('.wpcs-sd-options-img_pos').style.display = 'block';
                        document.querySelector('.wpcs-sd-options-img_height').style.display = 'block';
                        document.querySelector('.wpcs-sd-options-img_vertival_pos').style.display = 'block';
                        window.dispatchEvent(new Event('resize'));
                    } else {
                        document.querySelector('.wpcs-sd-options-img_pos').style.display = 'none';
                        document.querySelector('.wpcs-sd-options-img_height').style.display = 'none';
                        document.querySelector('.wpcs-sd-options-img_vertival_pos').style.display = 'none';
                    }
            ...
            img_height: {
                label: wpcs_sd.lang.flag_height,
                type: 'slider',
                min: 5,
                max: 100,
            ...
            show_description: {
                label: wpcs_sd.lang.show_description,
                type: 'switcher',
                ...
                callback: (is, element) => {
                    ...
                    if (is) {
                        document.querySelector('.wpcs-sd-options-description_font_size').style.display = 'block';
                        document.querySelector('.wpcs-sd-options-description_color').style.display = 'block';
                        document.querySelector('.wpcs-sd-options-description_font').style.display = 'block';
                        window.dispatchEvent(new Event('resize'));
                    } else {
                        document.querySelector('.wpcs-sd-options-description_font_size').style.display = 'none';
                        document.querySelector('.wpcs-sd-options-description_color').style.display = 'none';
                        document.querySelector('.wpcs-sd-options-description_font').style.display = 'none';
                    }
            ...
            description_font_size: {
                label: wpcs_sd.lang.description_font_size,
                type: 'slider',
                min: 8,
                max: 48,
            ...
            description_color: {
                label: wpcs_sd.lang.description_color,
                type: 'color',
            ...
            description_font: {
                label: wpcs_sd.lang.description_font,
                type: 'textinput',
            ...
            pointer_color: {
                label: wpcs_sd.lang.pointer_color,
                type: 'color',
            ...
            divider_color: {
                label: wpcs_sd.lang.divider_color,
                type: 'color',
            ...
            divider_size: {
                label: wpcs_sd.lang.divider_size,
                type: 'slider',
                min: 0,
                max: 10,
            ...
            max_open_height: {
                label: wpcs_sd.lang.max_opheight,
                type: 'slider',
                min: 50,
                max: 1000,
        ...
        this.options = new WPCS_SD_OPT(options, this.container);
    ...
    create_nav() {
        let nav = document.getElementById('wpcs-sd-nav');
        if (!nav) {
            nav = document.createElement('div');
            nav.setAttribute('id', 'wpcs-sd-nav');
            ...
            for (const [key, title] of Object.entries(this.menu)) {
                ...
                a.addEventListener('click', (e) => {
                    e.preventDefault();
                    document.querySelector(`#wpcs-sd-section-${key}`).scrollIntoView({behavior: 'smooth'});
                    return false;
                });
